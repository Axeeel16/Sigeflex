		...
		$resultado=mysqli_query($mysql, $consulta);
			...
			{?>
			...
			}else if($filas>=1)
				{
					...
					echo"<th>Id_usuario</th> <th>DNI</th> <th>Nombre</th> <th>Apellido</th> <th>Cargo</th> <th>Dir</th> <th>Tel</th> <th>Cel</th><th>Usuario</th> <th>Contraseña</th> <th>Edad</th> <th>Feacha de Nacimiento</th> <th>Permiso</th>";
